...
import { Distribution, Function, FunctionCode, FunctionEventType, HeadersFrameOption, HeadersReferrerPolicy, OriginAccessIdentity, ResponseHeadersPolicy } from 'aws-cdk-lib/aws-cloudfront';
...
export class CdkInfrastructureStack extends Stack {
  ...
  private _createDistribution(originAccessIdentity:OriginAccessIdentity, bucket:Bucket, redirectFunction: Function, securityPolicy:ResponseHeadersPolicy): Distribution {
  ...
  private _createSecurityPolicy(apiBaseUrl:string):ResponseHeadersPolicy{
    return new ResponseHeadersPolicy(this, 'ResponseHeadersPolicy', {
      ...
      securityHeadersBehavior: {
        ...
        referrerPolicy: { referrerPolicy: HeadersReferrerPolicy.STRICT_ORIGIN_WHEN_CROSS_ORIGIN, override: false },
        strictTransportSecurity: { accessControlMaxAge: Duration.seconds(31536000), includeSubdomains: false, override: false },
