...
import RswAuditExtractor from './rswAuditExtractor';

describe('RswAuditExtractor', () => {
  let rswAuditExtractor: Extractor;
  beforeEach(() => {
    rswAuditExtractor = new RswAuditExtractor();
  });
  describe('getMetadata', () => {
    test('with request body', async () => {
      ...
      const response = rswAuditExtractor.getMetadata(req, res);
