...
import { CFNTemplateParameters } from '../../base/aws/helpers/cloudFormationTemplate';
...
import { productIdRegExpString, provisionArtifactIdRegExpString } from '../../base/utilities/textUtil';
