...
[Code Sample](https://github.com/awslabs/solution-spark-on-aws/compare/develop...feat/sagemakerExample) for adding `sagemakerExample` environment. This is the code to add `sagemakerExample` for step 1 through 4.
