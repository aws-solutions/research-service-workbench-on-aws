...
import { generateRandomString, validRswName } from '../../support/utils/utilities';
...
describe('multiStep project tests', () => {
  ...
  beforeEach(async () => {
    ...
    projectName = generateRandomString(10, validRswName);
  });
  ...
  test('happy path', async () => {
    ...
    const newName = generateRandomString(10, validRswName);
  ...
  test('createProject', async () => {
    console.log('Creating Project');
    const projectName = generateRandomString(10, validRswName);
  ...
  test('updateProject', async () => {
    ...
    const otherName = generateRandomString(10, validRswName);
    const { data: createdProject2 } = await adminSession.resources.projects.create({
      name: otherName,
