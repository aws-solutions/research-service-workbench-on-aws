...
function help(){
    echo -e "${GREEN}
    Pre-requisites(Follow these steps in <PROJECT_ROOT>/solutions/rsw-reference/README.md):
        Installation steps:
        i) Setup Config File
        ii) Setup CDK
        iii) Deploy the code
...
function run() {
    ...
    INTEGRATION_TEST_CONFIG_FILE="${ROOT_DIR}/solutions/rsw-reference/integration-tests/config/${stage}.yaml"
