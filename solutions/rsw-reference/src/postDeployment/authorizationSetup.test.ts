    ...
    expect(authService.createIdentityPermissions).toBeCalledWith(
      expect.objectContaining({
        identityPermissions: expect.arrayContaining([
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_PROJECT }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_ENVIRONMENT }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_ENVIRONMENT_TYPE }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_ETC }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_PROJECT_LIST_BY_ETC }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_DATASET }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_USER }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_COST_CENTER }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_AWS_ACCOUNT }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_PROJECT_USER_ASSOCIATION }),
          expect.objectContaining({ subjectType: RswAuthZSubject.SWB_AWS_ACCOUNT_TEMPLATE_URL })
        ])
      })
    );
  });
