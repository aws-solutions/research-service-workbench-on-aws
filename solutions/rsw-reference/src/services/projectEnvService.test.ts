 ...
 */
import { ProjectDeletedError } from '@aws/rsw-app';
...
describe('ProjectEnvService', () => {
  ...
  describe('createEnvironment', () => {
    ...
    const envSubjectType: string = RswAuthZSubject.SWB_ENVIRONMENT;
    const envConnectionSubjectType: string = RswAuthZSubject.SWB_ENVIRONMENT_CONNECTION;
