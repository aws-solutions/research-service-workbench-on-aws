    ...
    GET: [
      {
        action: 'READ',
        subject: {
          subjectType: RswAuthZSubject.SWB_AWS_ACCOUNT,
          subjectId: '*'
        }
      }
    ],
    ...
    POST: [
      {
        action: 'CREATE',
        subject: {
          subjectType: RswAuthZSubject.SWB_AWS_ACCOUNT_TEMPLATE_URL,
          subjectId: '*'
        }
      }
    ]
    ...
    POST: [
      {
        action: 'CREATE',
        subject: {
          subjectType: RswAuthZSubject.SWB_COST_CENTER,
          subjectId: '*'
        }
      }
    ],
    ...
    PUT: [
      {
        action: 'UPDATE',
        subject: {
          subjectType: RswAuthZSubject.SWB_DATASET_ACCESS_LEVEL,
          subjectId: '${datasetId}'
        }
      }
    ],
    ...
    GET: [
      {
        action: 'READ',
        subject: {
          subjectType: RswAuthZSubject.SWB_DATASET_UPLOAD,
          subjectId: '${datasetId}',
          projectId: '${projectId}'
        }
      }
    ...
    GET: [
      {
        action: 'READ',
        subject: {
          subjectType: RswAuthZSubject.SWB_ENVIRONMENT_CONNECTION,
          subjectId: '${environmentId}',
          projectId: '${projectId}'
        }
      }
    ...
    GET: [
      {
        action: 'READ',
        subject: {
          subjectType: RswAuthZSubject.SWB_PROJECT_LIST_BY_ETC,
          subjectId: '*'
        }
      }
    ]
