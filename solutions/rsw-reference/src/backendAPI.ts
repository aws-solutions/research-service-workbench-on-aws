...
import { generateRouter, ApiRouteConfig } from '@aws/rsw-app';
import {
  AccountService,
  CostCenterService,
...
import { RSWEnvironmentService } from './services/rswEnvironmentService';
import { RSWProjectService } from './services/rswProjectService';
...
const apiRouteConfig: ApiRouteConfig = {
  ...
  environmentService,
  environmentPlugin: new RSWEnvironmentService(environmentService),
  ...
  projectPlugin: new RSWProjectService(dynamicAuthorizationService, projectService),
