...
2. Opening a Merge Request triggers build with 2 stages:
    ...
    - **secret-scan-eval** - Evaluates report generated by [Secret-Detection](https://docs.gitlab.com/ee/user/application_security/secret_detection/) template in the **security-scan** stage and fails the build if secrets are detected.
