...
For example to deploy `swb-reference` package to your AWS account, update the `aws-region` you want to deploy to and the `role-to-assume` you created [here](https://github.com/awslabs/monorepo-for-service-workbench/blob/main/.github/workflows/deploy-integration-swb-reference.yml#L37-L38)
