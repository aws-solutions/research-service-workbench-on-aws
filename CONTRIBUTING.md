...
For example to deploy `rsw-reference` package to your AWS account, update the `aws-region` you want to deploy to and the `role-to-assume` you created [here](https://github.com/aws-solutions/research-service-workbench-on-aws/blob/main/.github/workflows/deploy-integration-rsw-reference.yml#L37-L38)
